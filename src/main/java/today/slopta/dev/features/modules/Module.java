package today.slopta.dev.features.modules;
...
import today.slopta.dev.manager.ConfigManager;
import today.slopta.dev.util.traits.Jsonable;
import net.minecraft.util.Formatting;

public class Module extends today.slopta.dev.features.Module implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = Slopta.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Slopta.moduleManager.getModuleByName(name);
